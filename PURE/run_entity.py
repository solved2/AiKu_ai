...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', type=str, default=None, required=True, choices=['ace04', 'ace05', 'scierc', 'ko'])
        ...
        for _ in tqdm(range(args.num_epoch)):
            ...
            for i in tqdm(range(len(train_batches))):
                ...
                if global_step % args.print_loss_step == 0:
                    ...
                    writer.add_scalar('Loss/train', tr_loss / tr_examples, global_step / args.print_loss_step)
                    tr_loss = 0
                    tr_examples = 0
                ...
                if global_step % eval_step == 0:
                    ...
                    writer.add_scalar('F1/dev', f1, global_step / eval_step)
    ...
    if args.do_eval:
        ...
        output_ner_predictions(model, test_batches, test_data, output_file=prediction_file) # inferencing
